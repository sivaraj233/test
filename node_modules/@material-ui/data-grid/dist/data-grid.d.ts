...
import { ReactElement, RefObject, ElementType, MutableRefObject, Context, HTMLAttributes, ReactNode, ForwardRefExoticComponent, RefAttributes, FC, MemoExoticComponent, NamedExoticComponent, Component, MouseEvent } from 'react';
...
declare const useColumnReorder: (columnsRef: RefObject<HTMLDivElement>, apiRef: ApiRef) => {
    handleDragStart: (col: ColDef, currentTarget: HTMLElement) => void;
    handleColumnHeaderDragOver: (event: any) => void;
    handleDragOver: (col: ColDef, coordinates: CursorCoordinates) => void;
...
declare const ColumnHeaderItem: MemoExoticComponent<(props: ColumnHeaderItemProps) => JSX.Element>;
...
declare const ColumnHeaderItemCollection: NamedExoticComponent<ColumnHeadersItemCollectionProps>;
